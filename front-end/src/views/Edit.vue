...
<div class="form">
  ...
  <div class="suggestions"  style="margin: auto;" v-if="suggestions.length > 0">
    <div class="suggestion"  v-for="s in suggestions" :key="s.id" @click="selectItem(s)">{{s.BarbershopName}}
    </div>
  </div>
</div>
<br>
<div class="upload" v-if="findItem">
  <input v-model="findItem.BarbershopName">
  <p></p>
</div>
    ...
    async deleteItem(item) {
        ...
        async editItem(item) {
          try {
            ...
            BarbershopName: this.findItem.BarbershopName,
          });
          this.findItem = null;
          this.getItems();
          return true;
